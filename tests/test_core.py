...
class ParseTests(unittest.TestCase):
    ...
    def test_single_quote_allows_comment_suffix_without_value_leakage(self):
        self.assertEqual(parse("A='one' # note\n"), {"A": "one"})
    ...
    def test_carriage_return_line_endings_are_normalized_explicitly(self):
        self.assertEqual(parse("A=one\rB=two\r"), {"A": "one", "B": "two"})
